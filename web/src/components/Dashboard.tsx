...
import MobileWarningModal from './dashboard/views/detailed/components/MobileWarningModal'
import ComprehensiveHelpGuide from './shared/ComprehensiveHelpGuide'
import QuickHelpModal from './shared/QuickHelpModal'
  ...
  return (
    <>
      ...
      <QuickHelpModal
        ...
        onOpenFullGuide={() => setShowComprehensiveHelp(true)}
      />

      {/* Comprehensive Help Guide */}
      <ComprehensiveHelpGuide
        isOpen={showComprehensiveHelp}
        onClose={() => setShowComprehensiveHelp(false)}
      />
